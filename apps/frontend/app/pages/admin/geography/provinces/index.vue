...
<template>
  <div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
      <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Provinces</h1>
      <NuxtLink
        to="/admin/geography/provinces/new"
    ...
    <div class="mb-4">
      <input
        ...
        class="w-full max-w-md px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400"
      />
    </div>
        ...
        <tbody>
          ...
          >
            ...
            <td class="px-4 py-3 text-right">
              <NuxtLink
                :to="`/admin/geography/provinces/${item.id}`"
