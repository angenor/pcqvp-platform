...
<template>
  <div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
      <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Régions</h1>
      <NuxtLink
        to="/admin/geography/regions/new"
      ...
      <table class="w-full">
        <thead>
          <tr class="bg-gray-50 dark:bg-gray-700">
            ...
            <th class="px-4 py-3 text-left text-sm font-semibold text-gray-600 dark:text-gray-300">Province</th>
        ...
        <tbody>
          ...
          >
            ...
            <td class="px-4 py-3 text-gray-600 dark:text-gray-400">{{ item.province?.name ?? '-' }}</td>
            <td class="px-4 py-3 text-right">
              <NuxtLink
                :to="`/admin/geography/regions/${item.id}`"
    ...
    <div v-if="deletingId" class="fixed inset-0 bg-black/50 flex items-center justify-center z-50">
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 max-w-md w-full mx-4">
        ...
        <p class="text-gray-600 dark:text-gray-400 mb-4">
          Êtes-vous sûr de vouloir supprimer cette région ? Cette action est irréversible.
        </p>
